            ...
            while($row_data = mysqli_fetch_array($res)){
                ...
                <div class="flex-col pt-4 md:ml-24 mx-auto md:mx-0">
                    ...
                    <div class="mx-auto md:h-fit w-11/12 md:w-[600px] bg-card_white dark:bg-dark_red shadow-black shadow-lg rounded-lg p-8 text-black">
                        <span class="md:ml-3 text-sm md:text-base dark:text-whish">'.$row_data["date_posted"].'</span>
                        <div class="flex items-center text-sm md:text-base mt-2">
                            ...
                            <span class="ml-2 dark:text-whish">'.$row_data["username"].'</span>
                        </div>  
                        <div class="mt-2 text-lg font-extrabold md:text-3xl text-red dark:text-white"><span>'.$row_data["title"].'</span></div>
                        <div class="mt-4 text-sm md:text-base font-bold text-black">
                            <span class="dark:text-card_white">'.substr($row_data["content"], 0, 300).'...</span>
                        </div>
